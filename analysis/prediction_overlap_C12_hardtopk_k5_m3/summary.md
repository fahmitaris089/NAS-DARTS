...
## C12 Error Analysis
- C12 error count: 6
- C12 errors where EfficientNetV2M and ResNet50 are correct: 6
- C12 errors where MobileNetV3Small is correct: 4
- C12 errors where true label is in C12 top-5: 5
