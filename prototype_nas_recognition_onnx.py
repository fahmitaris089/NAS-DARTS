...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--reject-margin", type=float, default=0.30)
    ...
    parser.add_argument("--consensus-min-average-confidence", type=float, default=0.90)
    parser.add_argument("--consensus-min-average-margin", type=float, default=0.30)
