...
# 4. Raspberry Pi 5, final FP32 versus INT8
  python3 benchmark_compare_onnx_pi.py \
      --data-dir dataset/preprocessed \
      --split-path dataset/splits/split_info.json \
      --model-a models/onnx_fp32/NAS_L0.05_C12_cells10_KD.onnx \
      --model-b models/onnx_int8/NAS_L0.05_C12_cells10_KD_INT8.onnx \
      --threads 4 \
      --save-path results/deployment/benchmark_regenerated.json
"""
...
DEFAULT_SPLIT_PATH = (
    PROJECT_ROOT / "data" / "splits" / "split_info.json"
)
DEFAULT_MODEL_A = (
    PROJECT_ROOT / "models" / "onnx_fp32" / "NAS_L0.05_C12_cells10_KD.onnx"
)
DEFAULT_MODEL_B = (
    PROJECT_ROOT / "models" / "onnx_int8" / "NAS_L0.05_C12_cells10_KD_INT8.onnx"
)
